...
using TodoAppWithJWT.Models.DTO.Requests;
...
namespace TodoAppWithJWT.Controllers
{
    ...
    public class AuthManagementController : ControllerBase
    {
        ...
        public AuthManagementController(UserManager<IdentityUser> userManager,
            IOptionsMonitor<JwtConfig> optionsMonitor, TokenValidationParameters tokenValidationParameters, ApiDbContext apiDbContext)
        {
